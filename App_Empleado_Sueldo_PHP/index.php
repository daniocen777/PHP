...
<head>
	...
	<!-- PROBANDO ACTUALIZACIÓN DEL GIT-->
...
<div class="container">
	<form class="form-horizontal" role="form" method="POST" action="control/C_Insertar.php">
	...
	<div class="form-group">
		...
		<!--Vemos que los componentes input, textarea tienen aplicada la clase .form-control, esto es para que utilicen esta clase que crea Bootstrap por defecto y se expandan al 100% de su contenedor-->
			...
			<div class="col-lg-9">
				<input type="text" name="nombre" class="form-control" placeholder="Coloque su nombre" required />	
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-9">
				<input type="text" name="apMaterno" class="form-control" placeholder="Apellido materno" required/>	
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-9">
				<input type="text" id="datepicker" name="fechaNacimiento" placeholder=" yyyy-mm-dd" required/>	
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-9">
				 <div class="input-group">
				  	...
				  	<input type="text" class="form-control" name="txtSueldo" id="txtSueldo" placeholder="Sueldo del empleado" required/>
				 </div>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-9">
				<input type="number" class="form-control" name="txtHijos" id="txtHijos" placeholder="Número de hijos del empleado" min="0" max="10" required/>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-9">
				<input type="number" class="form-control" name="txtTiempo" id="txtTiempo" min="0" max="10" required/>
			</div>
		</div>

		
		<div class="form-group" class="col-lg-12">
			<button class="btn btn-primary">Guardar  <span class="glyphicon glyphicon-floppy-save" aria-hidden="true"></span></button>

			<a href="vistas/Lista_Empleados.php" class="btn btn-info" role="button">Lista de empleados <span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span></a>
		</div>
