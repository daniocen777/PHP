...
<html>
<head>
	<title>Pantalla Nodal</title>
	<link rel="stylesheet" href="../css/bootstrap.min.css">
	<link rel="stylesheet" type="text/css" href="../css/jquery-ui.min.css">
</head>
<body>

	<div class="modal fade" id="miventana2" tabindex="-1" rol="dialog" aria-labellebdy="myModalLabel" aria-hidden="true">
				...
				<div class="modal-body">
					<form role="form" method="POST" action="control/Control_Insertar.php" enctype="multipart/form-data">
						...
						<div class="row">
				 			 ...
				 			 <div class="col-md-10"><input type="text" name="isbn" class="form-control" placeholder="Año de publicación" id="isbn"/></div>
						</div>
