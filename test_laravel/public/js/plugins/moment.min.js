...
! function(a, b) {
    ...
    // LOCALES
    var fe = /D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/,
        ge = "Enero_Febrero_Marzo_Abril_Mayo_Junio_Julio_Agosto_Septiembre_Octubre_Noviembre_Deciembre".split("_"),
        he = "En_Feb_Mar_Abr_May_Jun_Jul_Ago_Sep_Oct_Nov_Dic".split("_"),
        ie = Vd,
        je = Vd;
    // FORMATTING
    T("Y", 0, 0, function() {
    ...
    // LOCALES
    var me = "Domingo_Lunes_Martes_Miércoles_Jueves_Viernes_Sábado".split("_"),
        ne = "Dom_Lun_Mar_Mie_Jue_Vie_Sab".split("_"),
        oe = "Do_Lu_Ma_Mi_Ju_Vi_Sa".split("_"),
        pe = Vd,
        qe = Vd,
        re = Vd;
